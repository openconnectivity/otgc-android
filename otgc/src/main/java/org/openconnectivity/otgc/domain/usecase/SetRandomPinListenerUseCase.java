...
public class SetRandomPinListenerUseCase {
    ...
    @Inject
    public SetRandomPinListenerUseCase(DoxsRepository doxsRepository) {
        this.doxsRepository = doxsRepository;
    }

    public void execute(OCSetRandomPinHandler randomPinCallbackListener) {
        doxsRepository.setRandomPinCallbackListener(randomPinCallbackListener);
    }
}
