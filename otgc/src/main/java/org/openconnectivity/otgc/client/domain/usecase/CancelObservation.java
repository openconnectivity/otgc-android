...
public class CancelObservation {
    ...
    @Inject
    public CancelObservation(ResourceRepository resourceRepository) {
        this.resourceRepository = resourceRepository;
    }

    public Completable execute(String resourceUri) {
        return resourceRepository.cancelObserve(resourceUri);
    }
}
